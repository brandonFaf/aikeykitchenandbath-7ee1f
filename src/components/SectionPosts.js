                ...
                <div className="post-feed-inside">
                  ...
                  <article key={post_idx} className="post post-card">
                    <div className="post-inside">
                      ...
                      <Link className="post-thumbnail" href={withPrefix(_.get(post, 'stackbit_url_path', null))}><img src={withPrefix(_.get(post, 'thumb_img_path', null))} alt={_.get(post, 'title', null)} /></Link>
                      )}
